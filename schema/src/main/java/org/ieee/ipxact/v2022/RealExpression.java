...
@XmlSeeAlso({
    ClockDriverType.ClockPeriod.class,
    ClockDriverType.ClockPulseOffset.class,
    ClockDriverType.ClockPulseDuration.class,
    SingleShotDriver.SingleShotOffset.class,
    SingleShotDriver.SingleShotDuration.class
})
