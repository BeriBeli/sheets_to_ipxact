 ...
 *         <element name="monitoredActiveInterface" type="{http://www.accellera.org/XMLSchema/IPXACT/1685-2022}monitorInterfaceType"/>
 *         <element name="monitorInterface" type="{http://www.accellera.org/XMLSchema/IPXACT/1685-2022}monitorInterfaceType" maxOccurs="unbounded"/>
...
public class MonitorInterconnection {
     ...
     * 
     * The componentInterfaceRef and busRef attributes indicate the instance name and bus interface name. The optional path attribute indicates the hierarchical instance name path to the component.
     * 
     */
    @XmlElement(required = true)
    protected MonitorInterfaceType monitoredActiveInterface;
    /**
     ...
     */
    @XmlElement(required = true)
    protected List<MonitorInterfaceType> monitorInterface;
    /**
     ...
     * @return
     *     possible object is
     *     {@link MonitorInterfaceType }
     *     
     */
    public MonitorInterfaceType getMonitoredActiveInterface() {
     ...
     */
    public void setMonitoredActiveInterface(MonitorInterfaceType value) {
     ...
     */
    public List<MonitorInterfaceType> getMonitorInterface() {
