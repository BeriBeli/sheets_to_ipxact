 ...
 *         <choice>
 *           <element name="wire" type="{http://www.accellera.org/XMLSchema/IPXACT/1685-2022}abstractorPortWireType"/>
 *           <element name="transactional" type="{http://www.accellera.org/XMLSchema/IPXACT/1685-2022}abstractorPortTransactionalType"/>
 *           <element name="structured" type="{http://www.accellera.org/XMLSchema/IPXACT/1685-2022}abstractorPortStructuredType"/>
 *         </choice>
...
@XmlType(name = "abstractorPortType", propOrder = {
    "name",
    "displayName",
    "shortDescription",
    "description",
...
public class AbstractorPortType {
     ...
     * 
     */
    protected AbstractorPortWireType wire;
    /**
     * Defines a port that implements or uses a service that can be implemented with functions or methods.
     * 
     */
    protected AbstractorPortTransactionalType transactional;
    /**
     * Represents a port that has subport structure.
     * 
     */
    protected AbstractorPortStructuredType structured;
     ...
     * @return
     *     possible object is
     *     {@link AbstractorPortWireType }
     *     
     */
    public AbstractorPortWireType getWire() {
        return wire;
    }
     ...
     * @see #getWire()
     */
    public void setWire(AbstractorPortWireType value) {
        this.wire = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link AbstractorPortTransactionalType }
     *     
     */
    public AbstractorPortTransactionalType getTransactional() {
     ...
     */
    public void setTransactional(AbstractorPortTransactionalType value) {
     ...
     * @return
     *     possible object is
     *     {@link AbstractorPortStructuredType }
     *     
     */
    public AbstractorPortStructuredType getStructured() {
        return structured;
    }
     ...
     * @see #getStructured()
     */
    public void setStructured(AbstractorPortStructuredType value) {
