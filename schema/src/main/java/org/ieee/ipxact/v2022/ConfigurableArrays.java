...
/**
 * <p>Java class for configurableArrays complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="configurableArrays">
 *   <complexContent>
...
@XmlType(name = "configurableArrays", propOrder = {
    "array"
})
public class ConfigurableArrays {
    ...
    protected List<ConfigurableArrays.Array> array;
     ...
     */
    public List<ConfigurableArrays.Array> getArray() {
        if (array == null) {
            array = new ArrayList<>();
        }
        return this.array;
