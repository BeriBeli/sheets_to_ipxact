 ...
 * 
 * <p>Java class for edgeValueType</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * <pre>{@code
 * <simpleType name="edgeValueType">
...
public enum EdgeValueType {
     ...
     */
    public static EdgeValueType fromValue(String v) {
        for (EdgeValueType c: EdgeValueType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
