 ...
 * 
 * 
 * <p>Java class for initiativeType</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * <pre>{@code
 * <simpleType name="initiativeType">
...
public enum InitiativeType {
     ...
     */
    public static InitiativeType fromValue(String v) {
        for (InitiativeType c: InitiativeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
