...
public class Vector {
    ...
    protected Vector.Left left;
    /**
     * The optional elements left and right can be used to select a bit-slice of a port vector to map to the bus interface.
     * 
     */
    @XmlElement(required = true)
    protected Vector.Right right;
     ...
     * @see #getLeft()
     */
    public void setLeft(Vector.Left value) {
        this.left = value;
    }
     ...
     * @see #getRight()
     */
    public void setRight(Vector.Right value) {
        this.right = value;
    }
