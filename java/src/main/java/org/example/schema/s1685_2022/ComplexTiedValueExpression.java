 ...
 * 
 * <p>Java class for complexTiedValueExpression complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="complexTiedValueExpression">
 *   <simpleContent>
 *     <extension base="<http://www.accellera.org/XMLSchema/IPXACT/1685-2022>simpleUnsignedBitVectorExpression">
...
@XmlType(name = "complexTiedValueExpression", propOrder = {
    "value"
})
public class ComplexTiedValueExpression {
