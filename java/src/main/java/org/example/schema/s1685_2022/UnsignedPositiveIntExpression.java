 ...
 * 
 * <p>Java class for unsignedPositiveIntExpression complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="unsignedPositiveIntExpression">
 *   <simpleContent>
...
@XmlType(name = "unsignedPositiveIntExpression")
@XmlSeeAlso({
    org.example.schema.s1685_2022.Wire.OnTarget.Width.class
})
public class UnsignedPositiveIntExpression
